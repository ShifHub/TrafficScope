...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        LocationsStorage.shared.loadHomePlacemark()
        LocationsStorage.shared.loadDestinationPlacemark()
        //UTD MUST BE LOADED BEFORE ETD; IT RELIES ON THE TIMING OF THE UTD
        DateStorage.shared.loadUTD()
        DateStorage.shared.loadETD()
